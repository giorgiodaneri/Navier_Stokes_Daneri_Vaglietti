...
//+
Transfinite Curve {9} = 150 Using Progression 1;
//+
Transfinite Curve {6} = 150 Using Progression 1;
//+
Transfinite Curve {5} = 200 Using Progression 1;
//+
Transfinite Curve {9, 9} = 200 Using Progression 1;
//+
Transfinite Curve {9, 6} = 100 Using Progression 1;
//+
Transfinite Curve {8, 7} = 70 Using Progression 1;
